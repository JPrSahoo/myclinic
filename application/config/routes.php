...
*/
$route['default_controller'] = 'auth/login'; // Login page
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
...
// Lab routes
$route['lab'] = 'lab/dashboard';
$route['lab/tests'] = 'lab/view_tests';


// Pharmacy routes
$route['pharmacy'] = 'pharmacy/dashboard';
$route['pharmacy/prescriptions'] = 'pharmacy/view_prescriptions';
...
//Ajax
$route['get-doctors-by-department'] = 'doctor/get_doctors_by_department';
