...
|
*/
$config['base_url'] = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on') ? "https" : "http"). "://" . $_SERVER['HTTP_HOST'] . "/myclinic/";

// $config['base_url'] = 'http://localhost/myclinic/';
...
|
*/
$config['encryption_key'] = 'jps@clinic@123#321#';
